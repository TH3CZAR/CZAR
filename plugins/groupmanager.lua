...
return '📜¦ _مرحبا عزيزي_ \n📜¦ _اذاعه المطورين بالتاكيد تم ايقافه ✔️_'
else
data[tostring(target)]["settings"]["lock_brod"] = "no"
save_data(_config.moderation.data, data) 
return '📜¦ _مرحبا عزيزي_ \n📜¦ _تم ايقاف اذاعه المطورين  ✔️_'
end
end
...
return '📜¦ _مرحبا عزيزي_ \n📜¦ _اذاعه المطورين بالتاكيد تم تشغيله ✔️_'
else 
data[tostring(target)]["settings"]["lock_brod"] = "yes"
save_data(_config.moderation.data, data) 
return '📜¦ _مرحبا عزيزي_ \n📜¦ _تم تشغيل اذاعه المطورين  ✔️_'
end
end
