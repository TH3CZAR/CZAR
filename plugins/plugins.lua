...
local update = 4; --  رقم اصدار السورس 
...
--[[
by TH3CZAR @TH3CZAR  \ @TH3CZAR
اي استفسار او لديك مشكله تابع قناتي @TH3CZAR 
او مراسلتي ع الخاص
...
-- by omer TH3CZAR TEle _ @TH3CZAR
...
local function run(msg, matches) 
  ...
  for k, v in pairs( plugins_names( )) do  
      -- get the name 
      v = string.match (v, "(.*)%.lua") 
      		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, "./plugins/"..v..".lua", '📜┇ الملف مقدم من قناه  القيصر ¦ֆ \n📜┇ تابع قناة السورس @TH3CZAR\n👨🏽‍🔧', dl_cb, nil)
...
tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, "./plugins/"..file..".lua", '📜┇ الملف مقدم من قناه  القيصر ¦ֆ \n📜┇ تابع قناة السورس @TH3CZAR\n👨🏽‍🔧', dl_cb, nil)
end
end
end
...
tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, send_file, '📜┇ الملف مقدم من قناه  القيصر ¦ֆ \n📜┇ تابع قناة السورس @TH3CZAR\n👨🏽‍🔧', dl_cb, nil)
end
...
tdcli.sendDocument(msg.from.id,0,0, 1, nil, "./data/moderation.json", '📜┇ الملف مقدم من قناه  القيصر ¦ֆ \n📜┇ يحتوي الملف على '..i..' مجموعات مفعلةة\n📜┇ تابع قناة السورس @TH3CZAR\n👨🏽‍🔧', dl_cb, nil)
...
--local dat, res = http.request('http://TH3CZAR99.esy.es/chek_update_cli.json')
...
--sleep(10)
--download_to_file('http://TH3CZAR99.esy.es/getuser.lua','getuser.lua')
--reload_plugins( )
